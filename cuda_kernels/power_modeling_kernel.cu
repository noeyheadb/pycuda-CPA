...
#define blockSize -1
#define targetByte1 -1
#define targetByte2 -1
// ##########################################

__constant__ int SBox[256] =
{
...
__device__ int AES_1_round_SubBytes(unsigned char* textin, unsigned char* textout, int key_1b, int target_byte)
{
    // #traces : blockIdx.y

    return SBox[textin[blockSize * blockIdx.y + target_byte] ^ key_1b];
}
